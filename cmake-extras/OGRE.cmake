...
function( copyWithSymLink SRC DST )
        message("copyWithSymLink :" ${SRC} -> ${DST})
	if( NOT APPLE )
		if( UNIX )
...
macro( setupPluginFileFromTemplate BUILD_TYPE OGRE_USE_SCENE_FORMAT )
	...
	if( CMAKE_BUILD_TYPE )
        ...
        message("OGRE_BUILD_TYPE_MATCHES :" ${OGRE_BUILD_TYPE_MATCHES})
	...
	if( WIN32 OR OGRE_BUILD_TYPE_MATCHES)
		...
		list( GET OGRE_DLLS 0 DLL_NAME )
                message("## " ${OGRE_DLL_PATH}/${DLL_OS_PREFIX}${DLL_NAME}${DLL_OS_SUFFIX})
...
message("setupOgre " ${OGRE_BINARIES})
...
elseif( APPLE )
	...
	link_directories( "${OGRE_BINARIES}/lib/$(PLATFORM_NAME)/$(CONFIGURATION)" )
        ...
        if(NOT CMAKE_BUILD_TYPE)
          message(FATAL_ERROR "CMAKE_BUILD_TYPE is not set please set it to Debug or Release")
        endif()
...
message("OGRE_SOURCE: " ${OGRE_SOURCE})
message("OGRE_BINARIES: " ${OGRE_BINARIES})
...
message( STATUS "Copy SDL2 dlls" )
if(WIN32)
    file( COPY "${OGRE_BINARIES}/bin/Debug/SDL2.dll" DESTINATION  "${CMAKE_SOURCE_DIR}/bin/Debug")
    file( COPY "${OGRE_BINARIES}/bin/Release/SDL2.dll" DESTINATION  "${CMAKE_SOURCE_DIR}/bin/Release")
endif()

message( STATUS "Copy amd_ags_x64 dlls" )
if(WIN32)
    file( COPY "${OGRE_BINARIES}/bin/Debug/amd_ags_x64.dll" DESTINATION  "${CMAKE_SOURCE_DIR}/bin/Debug")
    file( COPY "${OGRE_BINARIES}/bin/Release/amd_ags_x64.dll" DESTINATION  "${CMAKE_SOURCE_DIR}/bin/Release")
endif()
